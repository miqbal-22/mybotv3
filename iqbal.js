           ...
           break
                ...
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                     const pesan = body.slice(8)
                      if (pesan.length > 300) return iqbal.sendMessage(from, 'Teksnya Ke Panjang Ngentod, Maksimal 300 Teks', text, {quoted: mek})
