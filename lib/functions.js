...
const banner = cfonts.render(('BOT|JINGAN'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","green"],
...
module.exports = { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, info, start, success, banner, close }
