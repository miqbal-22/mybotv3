...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @_miqbal.22`)
})
...
else if (text.includes("salam")){
let hasil = fs.readFileSync('mp3/' + 'salam' + '.wav')
 conn.sendMessage(id, hasil, MessageType.audio, { ptt: true, quoted: m })
}
else if (text.includes("Salam")){
let hasil = fs.readFileSync('mp3/' + 'salam' + '.wav')
...
else if (text.includes("tariksis")){
...
else if (text.includes("tarik sis")){
let hasil = fs.readFileSync('mp3/' + 'tariksis' + '.wav')
 conn.sendMessage(id, hasil, MessageType.audio, { ptt: true, quoted: m })
}
else if (text.includes("Tarik sis")){
...
else if (text.includes("iri")){
let hasil = fs.readFileSync('mp3/' + 'iri' + '.wav')
 conn.sendMessage(id, hasil, MessageType.audio, { ptt: true, quoted: m })
}
else if (text.includes("Iri")){
let hasil = fs.readFileSync('mp3/' + 'iri' + '.wav')
...
let hasil = fs.readFileSync('mp3/' + 'sakit' + '.wav')
 conn.sendMessage(id, hasil, MessageType.audio, { ptt: true, quoted: m })
}
else if (text == 'Sakit'){
let hasil = fs.readFileSync('mp3/' + 'sakit' + '.wav')
...
let hasil = fs.readFileSync('mp3/' + 'bacot' + '.wav')
 conn.sendMessage(id, hasil, MessageType.audio, { ptt: true, quoted: m })
}
else if (text == 'bacot'){
let hasil = fs.readFileSync('mp3/' + 'bacot' + '.wav')
